...
//    }
    ...
    /**
     * 예) 회원과 팀을 조인하면서, 팀 이름이 teaA인 팀만 조인, 회원은 모두 조회
    ...
    @Test
    public void dynamicQuery_BooleanBuider() throws Exception {
    ...
    private BooleanExpression allEq(String usernameCond, Integer ageCond) {
        BooleanExpression userEq = usernameEq(usernameCond);
        return userEq != null ? userEq.and(ageEq(ageCond)) : ageEq(ageCond);
    }
    ...
    @Test
    public void bukUpdate() throws Exception {
